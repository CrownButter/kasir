<template>
  <nav class="bg-blue-600 text-white shadow-md sticky top-0 z-40 w-full">
    <div class="container mx-auto px-2 md:px-4 py-3 flex justify-between items-center max-w-full">
      ...
      <div class="flex items-center gap-1 md:gap-3 flex-shrink-0">
        ...
        <router-link 
            v-if="userRole === 'ADMIN'" 
            to="/admin" 
            class="bg-purple-600 hover:bg-purple-500 px-3 py-2 rounded-lg transition text-sm font-bold flex items-center gap-2 border border-purple-400 shadow-sm"
            active-class="bg-white text-purple-700 border-white">
...
// Helper untuk cek permission (opsional jika masih pakai $can di tempat lain)
// const can = (p) => { ... } 
